...
<div>
    ...
    <div class="flex items-center flex-row gap-5">
        <!-- Barra de busqueda -->
        <form action="{{ route("external-contacts.search") }}" method="post" data-type="external-contacts" class="searchForm w-[95%] flex items-center gap-2 border-1 border-[#E6E5DE] rounded-lg h-10 bg-white p-5">
            @csrf
