...
<div class="min-w-fit w-9/10 mx-auto flex flex-col mb-7 gap-10 dark:text-white">
    ...
    <div class="w-full flex flex-row justify-between items-center">
        <div class="w-fit flex flex-col gap-5">
            ...
            <h1 class="text-3xl font-bold text-[#011020] dark:text-white">Seguiment de: {{ $rrhh->topic }}</h1>
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-row justify-between gap-5">
            <!-- Historial -->
            <div class="flex flex-col justify-start w-5/8 gap-5 max-h-[640px] {{ $total<1 ? 'h-[170px]' : '' }} {{ $total==1 ? 'h-[360px]' : '' }} border border-[#AFAFAF] bg-white rounded-[15px] p-5 dark:bg-neutral-800 dark:border-neutral-600">
                    ...
                    @foreach ($comments as $comment )
                        <div class="flex flex-row gap-5">
                            <div class="flex flex-col">
                                <div class="bg-zinc-100 w-14 h-14 rounded-full border-3 border-zinc-300 dark:border-neutral-500">
            ...
            @unless ($rrhh->end_link)
                <!-- Formulario -->
                <div class="flex flex-col justify-center w-1/4 h-fit border border-[#AFAFAF] bg-white rounded-[15px] p-5 gap-5 max-h-[640px] min-w-min dark:bg-neutral-800 dark:border-neutral-600">
                    ...
                    <form action="{{ route('rrhh.tracking.store', $rrhh) }}" method="POST" class="text-[#5E6468] dark:text-white pt-5 flex flex-col gap-7">
                        @csrf
                        @method("POST")
