...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col mb-7 gap-10 dark:text-white">
    ...
    <div class="w-full flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div class="w-fit flex flex-col gap-5">
            ...
            <h1 class="text-2xl md:text-3xl font-bold text-[#011020] dark:text-white">Seguiment de: {{ $rrhh->topic }}</h1>
            ...
            <div class="flex flex-col justify-start w-full md:w-5/8 gap-5 max-h-screen-lg {{ $total<1 ? 'h-[170px]' : '' }} {{ $total==1 ? 'h-[360px]' : '' }} border border-[#AFAFAF] bg-white rounded-[15px] p-5 dark:bg-neutral-800 dark:border-neutral-600">
                ...
                <div class="overflow-y-scroll flex flex-col h-full">
                    ...
                    <div class="flex flex-row gap-5 items-center">
                        ...
                        <div class="text-zinc-300 dark:text-neutral-500">
                            Fi de l'historial
                        </div>
                    </div>
                    @else
                    ...
                    <form action="{{ route('rrhh.tracking.store', $rrhh) }}" method="POST" class="text-[#5E6468] dark:text-white pt-5 flex flex-col gap-7">
                        ...
                        <div class="flex flex-col gap-3">
                            <div class="flex flex-col gap-1">
                                ...
                                <textarea type="text" id="comment" name="comment" class="border border-[#AFAFAF] bg-white rounded-lg p-2 max-h-[360px] h-[200px] dark:bg-neutral-800 dark:border-neutral-600" required></textarea>
                            </div>
                        </div>
