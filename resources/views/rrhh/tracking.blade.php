...
<div class="min-w-fit w-9/10 mx-auto flex flex-col mb-7 gap-10">
    ...
    <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-row justify-between gap-5">
            <!-- Historial -->
            <div class="flex flex-col justify-start w-5/8 gap-5 max-h-[640px] {{ $total<1 ? 'h-[170px]' : '' }} {{ $total==1 ? 'h-[360px]' : '' }} border border-[#AFAFAF] bg-white rounded-[15px] p-5 min-w-max">
