...
<div class="w-full flex flex-col items-center justify-center dark:text-white">
    ...
    <div class="border border-[#AFAFAF] bg-white rounded-[15px] p-5  text-[#0F172A] min-w-max w-full sm:w-[60%] dark:bg-neutral-800 dark:border-neutral-600 dark:text-white">
        <form action="{{ route('rrhh.store') }}" method="POST">
            ...
            <select name="user_affected" id="user_affected" class="border-1 shadow-sm p-2 rounded-lg border-[#AFAFAF] w-full mb-5 dark:bg-neutral-800 dark:border-neutral-600">
            ...
            <div class="flex justify-end gap-5 mt-5">
                <a href="{{ route("rrhh.index") }}" class="bg-white text-[#011020] rounded-lg p-2 font-semibold flex items-center justify-center cursor-pointer gap-2 border-1 border-[#AFAFAF] dark:bg-neutral-800 dark:border-neutral-600 dark:text-white" >Cancel·lar</a>
