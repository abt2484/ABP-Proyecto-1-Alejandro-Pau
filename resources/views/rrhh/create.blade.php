...
<div class="w-full flex flex-col items-center justify-center">
    ...
    <div class="border border-[#AFAFAF] bg-white rounded-[15px] p-5 w-[60%] text-[#0F172A]">
        <form action="{{ route('rrhh.store') }}" method="POST">
            ...
            <input type="text" name="topic" id="derivative" class="border-1 shadow-sm p-2 rounded-lg border-[#AFAFAF] w-full mb-5" placeholder="Introdueix el derivat del tema pendent">
