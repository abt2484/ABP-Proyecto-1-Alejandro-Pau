  ...
  <title>Dashboard</title>
    ...
    <body class="bg-[#FFF9F6] px-10">
            ...
            <div class="w-full flex flex-wrap flex-row justify-between items-center">
                ...
                <div class="shadow-md simple-container w-96 mb-10">
                    ...
                    <div class="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-center">
                        ...
                        <button type="button" class="principal-button w-full sm:w-32 text-sm shadow-md">
                            Accedir
        ...
        <div class="flex flex-row flex-wrap gap-10">
            ...
            <!-- Container -->
            <div class="simple-container shadow-lg flex flex-col items-start w-72">
