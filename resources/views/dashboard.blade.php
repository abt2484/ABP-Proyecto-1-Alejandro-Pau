...
<div class="w-full mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
    ...
    <div class="border border-[#AFAFAF] bg-white rounded-[15px] p-5 shadow-lg flex flex-col items-start justify-between min-w-[250px]">
        <div class="flex flex-col items-start w-full">
            ...
            <ul class="my-5 w-full">
                <li>
                    <a href="{{ route("general-services.create") }}" class="p-2 rounded-lg mb-2 text-[#012F4A] flex flex-row items-center justify-between w-full cursor-pointer hover:bg-[#fef5eb] hover:text-[#FF7E13]">
                        Nou servei
                    <svg class="w-6 h-6">
                        <use xlink:href="#icon-no-line-arrow"></use>
                    </svg>
                ...
                <li>
                    <a href="{{ route("general-services.index") }}" class="p-2 rounded-lg mb-2 text-[#012F4A] flex flex-row items-center justify-between w-full cursor-pointer hover:bg-[#fef5eb] hover:text-[#FF7E13]">
                        Serveis actius
                    <svg class="w-6 h-6">
                        <use xlink:href="#icon-no-line-arrow"></use>
                    </svg>
