...
<div class="w-full flex flex-wrap flex-row justify-between items-center">
    ...
    <div class="shadow-md simple-container w-96 mb-10">
        ...
        <div class="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-center">
            ...
            <a href="{{ route("users.index") }}" class="btn-primary w-full sm:w-32 text-sm shadow-md">
                Accedir
                <svg class="w-4 h-4">
    ...
    <div class="shadow-md simple-container w-96 mb-10">
        <div class="flex justify-between items-center">
            <p class="principal-text-color font-bold card-title">Projectes/Comissions</p>
            <svg class="w-8 h-8 text-[#012F4A]">
...
<div class="flex flex-row justify-between flex-wrap gap-8">
    ...
    <div class="simple-container shadow-lg flex flex-col items-start w-80">
        ...
        <ul class="my-5 w-full">
            <li>
                <a href="{{ route("users.create") }}" class="list-option justify-between">
            ...
            <li>
                <a href="{{ route("users.index") }}" class="list-option justify-between">
                    Professional actius
                <svg class="w-6 h-6 text-[#012F4A]">
                    <use xlink:href="#icon-no-line-arrow"></use>
                </svg>
        ...
        <a href="{{ route("users.index") }}" class="btn-primary w-full p-3 font-bold">Accedir al apartat</a>
    </div>
    <!-- Container -->
    <div class="simple-container shadow-lg flex flex-col items-start w-80">
    ...
    <div class="simple-container shadow-lg flex flex-col items-start w-80">
        ...
        <ul class="my-5 w-full">
            <li>
                <a href="{{ route("projects.create") }}" class="list-option justify-between">
            ...
            <li>
                <a href="{{ route("projects.index") }}" class="list-option justify-between">
                    Projectes
                <svg class="w-6 h-6 text-[#012F4A]">
                    <use xlink:href="#icon-no-line-arrow"></use>
                </svg>
        ...
        <a href="{{ route("projects.index") }}" class="btn-primary w-full p-3 font-bold">Accedir al apartat</a>
