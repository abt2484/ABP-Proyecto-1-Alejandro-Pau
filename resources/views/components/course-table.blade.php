<tr class="mb-10 bg-white border-b border-[#AFAFAF] text-[#0F172A] hover:bg-[#eeeeee65] hover:transition-all">
    <td class="flex items-center gap-2 p-3">
        ...
        <a href="{{ route("courses.show", $course) }}" class="text-[#012F4A] font-bold text-[16px]">{{ $course->name }}</a>
    </td>
