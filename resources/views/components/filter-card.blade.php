<div id="filterContainer" data-element-type="{{ $type }}" class="w-screen h-screen bg-black/20 z-20 fixed inset-0 hidden">
    <div class="w-full h-full flex flex-col items-center justify-center">
        <div class=" w-[40%] min-w-[400px] bg-white rounded-lg flex flex-col">
            ...
            <div class="p-5">
                ...
                <div class="mt-4">
                    <div class="w-full flex flex-wrap gap-3 ">
                        <button class="w-[48%] cursor-pointer border-1 border-[#AFAFAF] p-2 rounded-lg flex flex-col items-start hover:border-orange-500 transition-all">
                        ...
                        <button class="w-[48%] cursor-pointer border-1 border-[#AFAFAF] p-2 rounded-lg flex flex-col items-start">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-orange-500">
                ...
                <div class="mt-4">
                    <div class="w-full flex gap-3 ">
                        <button class="w-[32%] border-1 border-[#AFAFAF] p-2 rounded-lg text-center cursor-pointer">
                            <p class="text-gray-700">Tots</p>
                        </button>
                        <button class="w-[32%] border-1 border-[#AFAFAF] p-2 rounded-lg text-center cursor-pointer">
                            <p class="text-gray-700">Actius</p>
                        </button>
                        <button class="w-[32%] border-1 border-[#AFAFAF] p-2 rounded-lg text-center cursor-pointer">
                            <p class="text-gray-700">Inactius</p>
                        </button>
                    </div>
                </div>
            </div>
