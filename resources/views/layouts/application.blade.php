...
<body class="bg-[#FFF9F6]">
    <header class="flex items-start">
        ...
        <div class="bg-white flex flex-row items-center gap-2 w-full p-5 shadow-sm pl-12">
            <img src="{{ asset("images/vallparadis-logo.svg") }}" alt="vallparadis-logo" class="w-56 mr-10">

            <form action="#" method="post" class="w-[60%]">
                @csrf
                <input type="search" name="search" id="search" placeholder="Buscar professionals , documents...." class="border-1 border-[#E6E5DE] rounded-lg h-10 bg-[#FFF9F6] w-full p-5 pl-14">
            </form>
        </div>
    </header>
    <main>
