    ...
    <header class="fixed top-0 left-0 flex items-start w-full h-auto z-10">
        ...
        <nav id="sidebar" class="bg-white h-screen p-5 shadow-sm flex flex-col items-start fixed top-0 left-0 z-10 w-20 transition-all duration-300">
            <ul class="flex flex-col gap-3 ">
                ...
                <li>
                    <a href="#Centers" class="list-option">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0F172A" class="size-7">
                ...
                <li>
                    <a href="#Users" class="list-option">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0F172A" class="size-7">
                ...
                <li>
                    <a href="#Projects" class="list-option">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#0F172A" class="size-6">
