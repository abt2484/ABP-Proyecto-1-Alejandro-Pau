...
<div class="w-full flex flex-col items-center justify-center gap-10">
    ...
    <!-- Apartado superior -->
    <div class="w-full md:w-4/5 flex justify-between items-center">
        <div class="flex flex-col gap-3">
            ...
            <h1 class="text-3xl font-bold text-[#011020] dark:text-white">Detalls de {{ $maintenance->topic }}</h1>
    ...
    <div class="border border-[#AFAFAF] bg-white dark:bg-neutral-800 rounded-[15px] p-5 md:w-4/5 w-full text-[#0F172A] dark:text-white flex items-center justify-between h-30 min-w-min dark:border-neutral-600">
        <p class="text-3xl font-bold text-[#011020] dark:text-white">{{ $maintenance->topic }}</p>
    ...
    <div class="gap-5 justify-center text-[#0F172A] dark:text-white w-full flex flex-col items-center">
        <div class="w-full md:w-4/5 flex flex-col lg:flex-row gap-5">
            <div class="border border-[#AFAFAF] bg-white dark:bg-neutral-800 rounded-[15px] p-5 lg:w-[50%] flex flex-col gap-3 w-full dark:border-neutral-600">
                <div class="flex gap-5 items-center">
                    ...
                    <p class="text-2xl font-bold text-[#011020] dark:text-white">Responsable</p>
                </div>
