<form action="{{ $action }}" method="POST">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
            ...
            <select name="type" id="type" class="w-full px-3 py-2 border border-gray-300 rounded-md dark:text-white dark:bg-neutral-800 dark:border-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('type') border-red-500 @enderror" required>
        ...
        <div>
            ...
            <input type="text" name="manager_name" id="manager_name" class="w-full px-3 py-2 border border-gray-300 rounded-md dark:text-white dark:bg-neutral-800 dark:border-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('manager_name') border-red-500 @enderror" value="{{ old("manager_name", $generalService->manager_name) }}" placeholder="Nom encarregat" required>
            @error("manager_name")
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <input type="email" name="manager_email" id="manager_email" class="w-full px-3 py-2 border border-gray-300 rounded-md dark:text-white dark:bg-neutral-800 dark:border-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('manager_email') border-red-500 @enderror" value="{{ old("manager_email", $generalService->manager_email) }}" placeholder="Email de l'encarregat" required>
            @error("manager_email")
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            ...
            <select name="is_active" id="is_active" class="w-full px-3 py-2 border border-gray-300 rounded-md dark:text-white dark:bg-neutral-800 dark:border-neutral-600 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('is_active') border-red-500 @enderror" required>
