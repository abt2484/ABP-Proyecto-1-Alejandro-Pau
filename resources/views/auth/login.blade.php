...
<div class="flex flex-col items-center justify-center h-screen">
  <form action="{{ route("login") }}" method="post" class="rounded-lg border-1 border-[#AFAFAF] p-10 shadow-2xl w-[30%] min-w-[300px] max-w-[500px]">
    @csrf
    <div class="flex justify-center mb-5">
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            viewBox="0 0 320 79.3" style="enable-background:new 0 0 320 79.3;" xml:space="preserve" class="max-w-[250px]">
            <style type="text/css">
                .st0{fill:#FF991C;}
                .st1{fill:#FF7121;}
                .st2{fill:#FFB517;}
    ...
    <h2 class="text-3xl  font-bold mb-10 text-center vallparadis-text-color">Intranet Vallparadis<h2>
      <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-3">
          <div class="flex items-center gap-2">
            ...
            <p class="font-bold vallparadis-text-color">Centre * </p>
          </div>
        ...
        <div class="flex flex-col gap-3">
          ...
          <div class="flex items-center gap-2">
            ...
            <p class="font-bold vallparadis-text-color">Correu electronic * </p>
          </div>

          <input type="text" name="email" id="email" placeholder="Elteucorreu@gmail.com" required class="border-1 p-2 rounded-lg border-gray-200 bg-white">
        </div>
        ...
        <div class="flex flex-col gap-3">
          <div class="flex items-center gap-2">
            ...
            <p class="font-bold vallparadis-text-color">Contrasenya * </p>
          </div>

          <input type="password" name="password" id="password" placeholder="La teva contrasenya" required class="border-1 p-2 rounded-lg border-gray-200 bg-white relative">
        </div>

        <button type="submit" name="submit" id="submit" class="mt-4 w-full font-bold border-1 p-3 primary-btn">
